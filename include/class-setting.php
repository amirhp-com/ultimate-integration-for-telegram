...
?>
      <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table wp-list-table widefat striped table-view-list posts">
              <thead>
                ...
                echo "<tr class='sync_site_tr border-top'><th colspan=2>
                    <h2 style='display: inline-block; margin:0;'>" . esc_html__("General Configuration", "ultimate-integration-for-telegram") . "</h2></th></tr>";
                ?>
              </thead>
              <tbody>
                <?php
          ...
          <div class="tab-content" data-tab="tab_workspace">
            ...
            <table class="form-table wp-list-table widefat striped table-view-list posts workspace-wrapper-parent">
              <thead>
                <?php
                echo "<tr class='sync_site_tr border-top'><th colspan=2>
                    <h2 style='display: inline-block; margin: 0;'>" . esc_html__("Notifications Panel", "ultimate-integration-for-telegram") . "</h2></th></tr>";
                ?>
                <tr>
                  <th colspan="2"><?php echo esc_textarea($this->render_workspace_tools()); ?></th>
                </tr>
              </thead>
              ...
              <tfoot>
                <tr class="type-textarea notifications toggle-export-import hide">
                  <th scope="row" colspan="2">
                    <h3 style="margin-top: 0;"><label for="notifications"><?php esc_html_e("Import / Export as JSON Data", "ultimate-integration-for-telegram"); ?></label></h3><a href="#" class="button button-secondary copy-code"><?php esc_html_e("Copy to Clipboard", "ultimate-integration-for-telegram"); ?></a><br>
                    <p class="data-textarea"><textarea name="ultimate-integration-for-telegram__notifications" id="notifications" rows="4" style="width: 100%; direction: ltr; font-family: monospace; font-size: smaller;" class="regular-text"><?php echo esc_textarea($this->read("notifications")); ?></textarea></p>
          ...
          <div class="submit_wrapper">
            ...
            <a href='#' class="button button-secondary button-hero send_test"><?php esc_html_e("Send Test Message", "ultimate-integration-for-telegram"); ?></a>
            <a href='#' class="button button-secondary button-hero connect"><?php esc_html_e("Connect Webhook", "ultimate-integration-for-telegram"); ?></a>
            <a href='#' class="button button-secondary button-hero disconnect"><?php esc_html_e("Disconnect Webhook", "ultimate-integration-for-telegram"); ?></a>
          </div>
        </form>
      </div>
      ...
      <div class="workspace-notifications-list">
        <div class="workspace-tools">
          <select id="notif_types">
            <option value=""><?php esc_html_e("-- Select Notif --", "ultimate-integration-for-telegram"); ?></option>
            <?php
        ...
        <div class="template-wrapper">
          ...
          ?>
          <template id="sample_setting_row_wrapper"><?php echo
                                                    // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                                    $this->sample_setting_row_wrapper(); ?></template>
    ...
    ?>
      <tr class="tg-message">
        ...
        <td>
          <textarea rows="4" data-slug="message">
            <?php
            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
          ...
          <p class="description">
            ...
            echo wp_kses_data(sprintf(
              ...
              "<a href='#' class='button button-link validate_markdown'>" . esc_html__("Markdown Validator", "ultimate-integration-for-telegram") . "</a>"
            )); ?>
          </p>
        </td>
      </tr>
      <tr class="tg-formatting">
        <th><?php esc_html_e("HTML Formatting", "ultimate-integration-for-telegram"); ?></th>
        <td>
          <label><input type="checkbox" <?php echo checked($default_parser, true, false); ?> data-slug="html_parser" value="html">&nbsp;
            <?php esc_html_e("Enable (green) to use HTML, or disable (red) to use Markdown", "ultimate-integration-for-telegram"); ?></label>
        </td>
      </tr>
      <tr class="description">
        <td colspan="2" class="macro-list">
          <?php
          echo "<h4 style='color: #1d2327;margin: 0;font-weight: normal;'>" . esc_html__("Available Macros for this Notif", "ultimate-integration-for-telegram") . "</h4>";
          ?>
      ...
      <tr class="tg-buttons">
        <th><?php esc_html_e("Buttons", "ultimate-integration-for-telegram"); ?></th>
        <td>
          <textarea rows="4" data-slug="btn_row1" placeholder="<?php echo esc_attr($btn_placeholder); ?>"><?php echo esc_textarea($default_buttons); ?></textarea>
          <p class="description">
            <?php esc_html_e("You can add up to four buttons. Both labels and URLs can use plain text or macros, and labels can also include emojis. You can use @page_slug, #page_id or {special_pages} supported by PeproDev Ultimate Profile Solutions as button URL too.", "ultimate-integration-for-telegram"); ?>
            <br><?php
                echo sprintf(
                  /* translators: 1: sample btn */
                  esc_attr__("Sample Button: %s", "ultimate-integration-for-telegram"),
